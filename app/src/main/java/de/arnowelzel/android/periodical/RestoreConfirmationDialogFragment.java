/*
 * Periodical dialog fragment for restore confirmation
...
public class RestoreConfirmationDialogFragment extends DialogFragment {
    public static final String TAG = "RestoreConfirmationDialog";
    public static final String RESULT_BUNDLE_KEY = "resultRestoreConfirm";
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        return new AlertDialog.Builder(getActivity())
            ...
            .setMessage(getResources().getString(R.string.restore_text))
