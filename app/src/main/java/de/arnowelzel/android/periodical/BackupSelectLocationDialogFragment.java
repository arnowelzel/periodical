/*
 * Periodical dialog fragment for backup location selection
...
public class BackupSelectLocationDialogFragment extends DialogFragment {
    public static final String TAG = "BackupSelectLocationDialog";
    public static final String RESULT_BUNDLE_KEY = "resultBackupSelectLocation";
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        return new AlertDialog.Builder(getActivity())
            ...
            .setMessage(getResources().getString(R.string.backup_selectfolder))
